...
def dynamodb_delete(context, id, resource_name):
    ...
    table_name = set_tablename(context)
...
@then("the data for id {id} in the dynamoDB table has been deleted")
...
def set_tablename(context):
    table_name = context.resource_name
