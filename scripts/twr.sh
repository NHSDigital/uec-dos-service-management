        ...
        do
            if ! [ "$dir" == $APPLICATION_DIR ] ; then
                if [ -d $APPLICATION_DIR/"$dir/test" ]; then
                    ...
                    cp -r $APPLICATION_DIR/"$dir"/test/test_* $APPLICATION_DIR/"$dir"
                    cp -r $APPLICATION_UTIL_DIR/* $APPLICATION_DIR/"$dir"
...
#                     echo "Preparing tests for $dir"
#                     cp -r $APPLICATION_UTIL_DIR/"$dir"/test/test_* $APPLICATION_UTIL_DIR/"$dir"
#                     # cp -r $APPLICATION_UTIL_DIR/* $APPLICATION_DIR/"$dir"
#                     echo "Running tests for $dir"
#                     # pip install -r $APPLICATION_DIR/"$dir"/test/requirements.txt
