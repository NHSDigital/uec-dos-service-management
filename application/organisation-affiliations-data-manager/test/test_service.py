...
def create_mock_dynamodb():
    "Create a mock implementation of the dynamodb organisation-affiliations table"
...
def build_mock_organisation_affiliations_item():
...
def test_get_record_by_id():
    ...
    organisation_affiliations_record = build_mock_organisation_affiliations_item()
    table.put_item(Item=organisation_affiliations_record, TableName=service.TABLE_NAME)
...
def test_add_record():
    ...
    # build record to add
    organisation_affiliations_record = build_mock_organisation_affiliations_item()
    organisation_affiliations_record["active"] = mock_status_update
    organisation_affiliations_record["id"] = mock_post_id
    service.add_record(organisation_affiliations_record)
    response = table.get_item(Key={"id": mock_post_id})
...
def test_update_record():
    ...
    # update elements
    organisation_affiliations_record["active"] = mock_status_update
    organisation_affiliations_record["name"] = mock_updated_name
    service.update_record(organisation_affiliations_record)
