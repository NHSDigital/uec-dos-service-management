...
def test_add_record():
    ...
    # build record to add
    location_record = build_mock_location_item()
    location_record["active"] = mock_status_update
    location_record["id"] = mock_post_id
    service.add_record(location_record)
    response = table.get_item(Key={"id": mock_post_id})
...
def test_update_record():
    ...
    # update elements
    location_record["active"] = mock_status_update
    location_record["name"] = mock_updated_name
    service.update_record(location_record)
